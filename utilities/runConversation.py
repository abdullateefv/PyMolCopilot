...
from backend.appearanceFunctions import bgColor_cmd, cartoon_cmd, refresh_cmd, color_cmd, recolor_cmd
from backend.moleculeCRUDFunctions import create_cmd, bond_cmd, protect_cmd, attach_cmd, pop_cmd, identify_cmd
...
def run_conversation(newMessage, verbose):
    ...
    if tool_calls:
        ...
        available_functions = {
            ...
            "color_cmd": color_cmd,
            "pop_cmd": pop_cmd,
            "recolor_cmd" : recolor_cmd,
            "identify_cmd" : identify_cmd
        }
